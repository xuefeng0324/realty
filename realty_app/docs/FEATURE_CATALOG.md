...
**期望**：数字来自对应 CSV；空则隐藏或空态；**NBS 多期销售面积同比可并列展示**；广州库存卡新鲜度；深圳计划入市；广州住房发展计划；**广州居住用地成交**（仅 R2/居住，土地价款≠房价）；涨跌色涨红跌绿；网签/70城城市名须同步 store（不可等异步 cities）。  
...
| 2026-07-26 | F-DASH-11 | 广州居住用地成交 + 网签/70城城市同步 | 1.121.56 | 规自局 HTML；对抗 city sync |
