...
const matrix = {
  ...
  school: ["房源标签云", "区情画像", "学区 5 维评分", "学区溢价榜", "教育事业"],
...
try {
  ...
  if (await page.locator("[data-education-overview]:visible").count() <= 0) {
    issues.push("学区页签缺少教育事业概览卡（store 城市名应对齐 education_overview）");
  }
