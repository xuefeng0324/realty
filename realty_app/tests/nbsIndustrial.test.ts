...
describe("nbs industrial value added", () => {
  ...
  it("CSV 解析拒绝非 stats.gov.cn", () => {
    const rows = loadNbsIndustrialFromCSV(
      [
        "month,publish_date,yoy_pct,mom_pct,ytd_yoy_pct,mining_yoy_pct,manufacturing_yoy_pct,utilities_yoy_pct,source_url",
        "2099-01,2099-02-01,5,0.1,5,1,5,5,https://evil.example/x",
        "2099-02,2099-03-01,5.5,0.2,5.2,1.1,5.1,5.3,https://www.stats.gov.cn/a"
      ].join("\n")
    );
