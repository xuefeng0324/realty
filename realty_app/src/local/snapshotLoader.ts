...
const OPTIONAL_FILES: Array<[keyof SnapshotInputs, string]> = [
  ...
  ["listingTagsSummaryCSV", "listing_tags_summary.csv"],
  ["poiMarketCSV", "poi_market.csv"],
  ["poiCommercialCSV", "poi_commercial.csv"],
  ["adminDistrictCSV", "admin_districts.csv"],
  ["hospitalsGeoCSV", "hospitals_geo.csv"],
