...
export function getDistrictMeta(): LocalDistrictMeta[] {
  return snapshot?.districtMeta ?? [];
}
...
export function getListingFreshness(): LocalListingFreshness[] {
  return snapshot?.listingFreshness ?? [];
}
