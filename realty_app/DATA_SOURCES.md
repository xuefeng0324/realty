...
| `static/seed/safe_usd_mid.csv` | `safeUsdMid.ts` + dashboard「💱 美元中间价」 | `crawl_safe_usd_mid.py`（**周/月更 CI**；RMBQuery.do 按月窗） | 外管局中间价查询：日度 100 美元折合人民币 ÷100；本月均价派生；**≠房价**；可与金融统计月末汇率对照 |
