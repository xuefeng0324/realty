...
| `static/seed/pbc_fin_stats.csv` | `pbcFinStats.ts` + dashboard「📊 金融统计（社融/M2）」 | `crawl_pbc_fin_stats.py`（**周/月更 CI**） | 央行「金融统计数据报告」：社融存量/增量、M2/M1、人民币贷款、住户及中长期贷款、质押式回购利率；**≠房价**；住户中长期贷≠按揭成交 |
